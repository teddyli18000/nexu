...
export type GetApiV1ChannelsSlackClaimInfoData = {
    body?: never;
    path?: never;
    query: {
        token: string;
...
export type GetApiV1ChannelsSlackClaimInfoResponses = {
    /**
     * Claim token workspace information
     */
    200: {
        valid: boolean;
        expired: boolean;
...
export type GetApiV1ChannelsSlackClaimInfoResponse = GetApiV1ChannelsSlackClaimInfoResponses[keyof GetApiV1ChannelsSlackClaimInfoResponses];

export type PostApiV1ChannelsSlackClaimData = {
    body?: {
        claimToken: string;
    };
    path?: never;
...
export type PostApiV1ChannelsSlackClaimErrors = {
    /**
...
export type PostApiV1ChannelsSlackClaimError = PostApiV1ChannelsSlackClaimErrors[keyof PostApiV1ChannelsSlackClaimErrors];

export type PostApiV1ChannelsSlackClaimResponses = {
    /**
     * Claim workspace membership
     */
    200: {
        success: boolean;
        teamName: string;
...
export type PostApiV1ChannelsSlackClaimResponse = PostApiV1ChannelsSlackClaimResponses[keyof PostApiV1ChannelsSlackClaimResponses];

export type GetApiV1ChannelsSlackMembershipData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetApiV1ChannelsSlackMembershipResponses = {
    /**
     * Current user's shared Slack workspace membership
     */
    200: {
...
export type GetApiV1ChannelsSlackMembershipResponse = GetApiV1ChannelsSlackMembershipResponses[keyof GetApiV1ChannelsSlackMembershipResponses];
