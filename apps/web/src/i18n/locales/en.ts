const en = {
  ...
  // ── Growth / Rewards (digital #106) ──
  "layout.nav.rewards": "Rewards",
  "layout.mobile.rewards": "Rewards",
  "layout.mobile.rewardsSubtitle": "Earn bonus usage",
  "budget.viral.title": "Earn more usage",
  "budget.viral.allComplete": "Rewards center",
  "budget.viral.loginFirst": "Log in for free AI models",
  "budget.viral.rules": "Reward rules",
  "budget.resetsIn1": "Resets in 1d",
  "budget.resetsIn": "Resets in {n}d",
  "budget.label": "Usage",
  "budget.cycleTooltip1": "Billing cycle resets in 1 day",
  "budget.cycleTooltip": "Billing cycle resets in {n} days",
  "budget.cycle": "Cycle",
  "budget.bonusIncluded": "Includes ${n} bonus",
  "budget.windowTooltip0": "Rolling window resets soon",
  "budget.windowTooltip": "Rolling window resets in {n}h",
  "budget.window": "Rolling window",
  "budget.confirm.title": "Finished: {channel}",
  "budget.confirm.desc": "When you're done, confirm to claim +${n}.",
  "budget.confirm.checkinDesc": "Check in to add +${n} to your bonus balance.",
  "budget.confirm.imageDesc":
    "Download the card, post it, then confirm for +${n}.",
  "budget.confirm.screenshotDesc": "After you post, confirm to claim +${n}.",
  "budget.confirm.downloadImage": "Download share card",
  "budget.confirm.cancel": "Cancel",
  "budget.confirm.done": "Done",
  "budget.cta.done": "Done +${n}",
  "budget.cta.checkin": "Check in",
  "budget.cta.download": "Download",
  "budget.cta.share": "Share",
  "budget.cta.go": "Open",
  "rewards.title": "Rewards center",
  "rewards.desc": "Complete tasks to earn bonus usage.",
  "rewards.group.daily": "Daily",
  "rewards.group.opensource": "Open source",
  "rewards.group.social": "Social",
  "rewards.group.messaging": "Messaging",
  "rewards.checkinTotal": "Lifetime daily check-in bonus: ${n}",
  "reward.daily_checkin.name": "Daily check-in",
  "reward.daily_checkin.desc": "Come back each day for a small bonus.",
  "reward.github_star.name": "Star on GitHub",
  "reward.github_star.desc": "Star nexu on GitHub to support the project.",
  "reward.x_share.name": "Share on X",
  "reward.x_share.desc": "Tweet about nexu with the suggested text.",
  "reward.reddit.name": "Post on Reddit",
  "reward.reddit.desc": "Share nexu in a relevant subreddit.",
  "reward.xiaohongshu.name": "Post on Xiaohongshu",
  "reward.xiaohongshu.desc": "Share the download card in a note.",
  "reward.lingying.name": "Share on LinkedIn",
  "reward.lingying.desc": "Share the GitHub link on LinkedIn.",
  "reward.jike.name": "Post on Jike",
  "reward.jike.desc": "Share the download card on Jike.",
  "reward.wechat.name": "WeChat Moments",
  "reward.wechat.desc": "Share the download card in Moments.",
  "reward.feishu.name": "Share in Feishu",
  "reward.feishu.desc": "Share the download card in Feishu.",
  ...
  "models.managed.refreshModelList": "Refresh",
